...
/**Класс UserComparator выполняет только одну функцию -
 * сравнение двух объектов Класса User по ФИО (Single Responsibility)
 * Имплементирует только 2 нужных интерфейса */
